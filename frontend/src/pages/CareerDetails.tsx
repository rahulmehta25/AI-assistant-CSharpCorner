    ...
    <div id="career-details-container" className="container mx-auto py-8 px-4 max-w-3xl">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div id="career-details-grid" className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <CardContent>
              <div
                ...
                aria-valuemin={0}
                aria-valuemax={100}
                aria-label={`${career.matchScore}% match`}
              >
          ...
          <Card id="career-salary-card" className="hover:border-primary/20 transition-colors duration-200">
            <CardHeader className="pb-2">
          ...
          <Card id="career-growth-card" className="hover:border-primary/20 transition-colors duration-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-muted-foreground flex items-center gap-1">
          ...
          {career.timeToTransition && (
            <Card id="career-transition-card" className="hover:border-primary/20 transition-colors duration-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-muted-foreground flex items-center gap-1">
        ...
        <Card id="career-description-card" className="mb-4 hover:border-primary/20 transition-colors duration-200">
          <CardHeader>
        ...
        <Card id="career-skills-card" className="mb-4 hover:border-primary/20 transition-colors duration-200">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
        ...
        {career.companies && career.companies.length > 0 && (
          <Card id="career-companies-card" className="hover:border-primary/20 transition-colors duration-200">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
